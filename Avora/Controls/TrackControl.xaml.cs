...
using static Avora.Helpers.ExtendedAudio;
    ...
    public sealed partial class TrackControl : UserControl, INotifyPropertyChanged
    {
        ...
        private void TrackControl_Unloaded(object sender, RoutedEventArgs e)
        {
            ...
            if (dataTrack != null)
            {
                ...
                dataTrack.trackOwnerChanged -= OnTrackOwnerChanged;
            }
            //   this.DataContextChanged -= TrackControl_DataContextChanged;
            //   Loaded -= TrackControl_Loaded;
            //   Unloaded -= TrackControl_Unloaded;
        ...
        private void OnTrackOwnerChanged(object sender, EventArgs e)
        {
            this.DispatcherQueue.TryEnqueue(() =>
            {
                if (dataTrack != null)
                {
                    ...
                    AddedCheckIcon.Visibility = isOwner ? Visibility.Visible : Visibility.Collapsed;
                }
            });
        }
        string? berImageLink = "";
        ...
        private void UCcontrol_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (dataTrack.PlayThis && Avora.Services.MediaPlayerService.MediaPlayer.CurrentState != Windows.Media.Playback.MediaPlayerState.Paused)
            {
