...
namespace Avora.Views.ModalsPages
{
    ...
    public sealed partial class LyricsPage : Page, INotifyPropertyChanged
    {
        ...
        public VkNet.Model.Attachments.Audio Track =>
            Avora.Services.MediaPlayerService.PlayingTrack?.audio;
        ...
        private async void OnTimerTick(object sender, object e)
        {
            ...
            {
                timerTickCangeCheck.Invoke(this, new ArgsSeconds((int)Avora.Services.MediaPlayerService.MediaPlayer.Position.TotalMilliseconds));
            }

            if (disabledAutoScroll)
                return;

            var item = GetLineNumberBySeconds((int)Avora.Services.MediaPlayerService.MediaPlayer.Position.TotalMilliseconds);
