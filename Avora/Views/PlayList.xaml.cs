...
namespace Avora.Views
{
    ...
    public sealed partial class PlayList : Page
    {
        ...
        private IVKGetAudio Tracks
        {
            get
            {
                return Avora.Services.MediaPlayerService.iVKGetAudio;
            }
            set { Avora.Services.MediaPlayerService.iVKGetAudio = value; }
        ...
        public PlayList()
        {
            ...
            Avora.Services.MediaPlayerService.onClickonTrack += AudioPlayer_onClickonTrack;
        }
