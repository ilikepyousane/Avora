            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                ...
                switch (RuntimeInformation.OSArchitecture)
                {
                    case Architecture.X86:
                        return "https://github.com/ilikepyousane/Avora/releases/download/0.1.0/ffmpeg-X32.zip";
                    case Architecture.X64:
                        return "https://github.com/ilikepyousane/Avora/releases/download/0.1.0/ffmpeg-X64.zip";
                    case Architecture.Arm64:
                        return "https://github.com/ilikepyousane/Avora/releases/download/0.1.0/ffmpeg-ARM64.zip";
