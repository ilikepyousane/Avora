...
namespace Avora
{
    public sealed partial class MainWindow : Microsoft.UI.Xaml.Window
    {
        ...
        private void InitializeWindowProperties()
        {
            ...
            var presenter = (Microsoft.UI.Windowing.OverlappedPresenter)m_AppWindow.Presenter;
            presenter.SetBorderAndTitleBar(true, false);

            var savedTheme = DB.SettingsTable.GetSetting("appTheme");
            string theme = (savedTheme != null && savedTheme.settingValue == "light") ? "light" : "dark";
            ApplyTheme(theme);
        }
        ...
        private void Content_KeyDown(object sender, Microsoft.UI.Xaml.Input.KeyRoutedEventArgs e)
        {
            ...
            {
                _ = Services.MediaPlayerService.TogglePlayPause();
                e.Handled = true;
            }
            else if (e.Key == Windows.System.VirtualKey.F && isCtrl)
            {
                Services.MediaPlayerService.PlayNextTrack();
                e.Handled = true;
            }
            else if (e.Key == Windows.System.VirtualKey.A && isCtrl)
            {
                Services.MediaPlayerService.PlayPreviousTrack();
                e.Handled = true;
            }
        }
        ...
        private void InitializeEventHandlers()
        {
            ...
            this.Content.AddHandler(Microsoft.UI.Xaml.UIElement.KeyDownEvent,
                new Microsoft.UI.Xaml.Input.KeyEventHandler(Content_KeyDown), true);

            PlayListDownload.OnEndAllDownload += OnEndAllDownload_Event;
            Avora.Views.Tasks.TaskAction.tasks.CollectionChanged += Tasks_CollectionChanged;
            Avora.Views.Notification.Notification.Notifications.CollectionChanged += Notifications_CollectionChanged;
        ...
        private void InitializeSystemIntegration()
        {
            ...
            string iconPath = Path.Combine(assetsPath, "empty.ico");
            LoadIcon(iconPath);
        ...
        public Avora.SnowFlake.SnowFlakeEffect Snow { get { return snow; }  }
        ...
        private void UI_ColorValuesChanged(UISettings sender, object args)
        {
            ...
            {
                var saved = DB.SettingsTable.GetSetting("appTheme");
                bool isDark = saved == null || saved.settingValue != "light";
                AppWindowTitleBar m_TitleBar = m_AppWindow.TitleBar;
                m_TitleBar.ButtonForegroundColor = isDark ? Colors.White : Colors.Black;
            });
        }

        private void Tasks_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            if (Avora.Views.Tasks.TaskAction.tasks.Count == 0)
            {
                TasksBTN.HideButton();
        ...
        {
            if (Avora.Views.Notification.Notification.Notifications.Count == 0)
            {
                NotifList.Hide();
        ...
        {
            var current = DB.SettingsTable.GetSetting("appTheme");
            string next = (current != null && current.settingValue == "light") ? "dark" : "light";
            DB.SettingsTable.SetSetting("appTheme", next);
            ApplyTheme(next);
        }
        ...
        {
            var tb = m_AppWindow.TitleBar;
            if (theme == "light")
            {
                tb.ButtonBackgroundColor = Windows.UI.Color.FromArgb(255, 245, 245, 245);
                tb.ButtonInactiveBackgroundColor = Windows.UI.Color.FromArgb(255, 245, 245, 245);
                tb.ButtonHoverBackgroundColor = Windows.UI.Color.FromArgb(255, 220, 220, 220);
                tb.ButtonPressedBackgroundColor = Windows.UI.Color.FromArgb(255, 200, 200, 200);
                tb.ButtonForegroundColor = Windows.UI.Color.FromArgb(255, 30, 30, 30);
                ...
                ThemeIcon.Glyph = "\uE706";
                TitIcon.Source = new Microsoft.UI.Xaml.Media.Imaging.BitmapImage(new Uri("ms-appx:///Assets/AvoraLogoLight.png"));
            }
            else
            {
                tb.ButtonBackgroundColor = Windows.UI.Color.FromArgb(255, 0, 0, 0);
                tb.ButtonInactiveBackgroundColor = Windows.UI.Color.FromArgb(255, 0, 0, 0);
                tb.ButtonHoverBackgroundColor = Windows.UI.Color.FromArgb(255, 40, 40, 40);
                tb.ButtonPressedBackgroundColor = Windows.UI.Color.FromArgb(255, 60, 60, 60);
                ...
                ThemeIcon.Glyph = "\uE793";
                TitIcon.Source = new Microsoft.UI.Xaml.Media.Imaging.BitmapImage(new Uri("ms-appx:///Assets/AvoraLogoDark.png"));
            }
        }
        #endregion
